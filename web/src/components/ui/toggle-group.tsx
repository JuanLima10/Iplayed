  ...
  return (
    <div className="space-y-2.5">
      ...
      <ToggleGroupPrimitive.Root
        ...
        className={cn(
          'group/toggle-group flex w-fit flex-row flex-wrap items-center justify-center gap-[--spacing(var(--gap))] rounded-lg data-[size=sm]:rounded-[min(var(--radius-md),10px)] sm:flex-nowrap data-vertical:flex-col data-vertical:items-stretch',
          className
        )}
        {...props}
      >
