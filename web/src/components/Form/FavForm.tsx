  ...
  return (
    <Dialog.Root>
      ...
      <Dialog.Portal>
        ...
        <Dialog.Content className="w-[600px] max-w-[90%] h-auto max-h-[90%] min-h-[200px] flex justify-center fixed top-2 left-[50%] translate-x-[-50%] translate-y-0 z-20 bg-blue-700 rounded-3xl data-[state=open]:animate-contentShow focus:outline-none" onCloseAutoFocus={() => router.push(pathName)}>
